(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('next/router'), require('next-cookies'), require('js-cookie')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'next/router', 'next-cookies', 'js-cookie'], factory) :
	(global = global || self, factory(global.nextAuthorization = {}, global.React, global.Router, global.nextCookie, global.cookie));
}(this, function (exports, React, Router, nextCookie, cookie) { 'use strict';

	React = React && React.hasOwnProperty('default') ? React['default'] : React;
	Router = Router && Router.hasOwnProperty('default') ? Router['default'] : Router;
	nextCookie = nextCookie && nextCookie.hasOwnProperty('default') ? nextCookie['default'] : nextCookie;
	...
	function withAuth(_ref2) {
	  var callback = _ref2.callback,
	      serverRedirect = _ref2.serverRedirect;
	...
	var auth = function auth(_ref3) {
	  var context = _ref3.context,
	      ...
	      serverRedirect = _ref3.serverRedirect;
